...
import {NumericInputFieldComponentState} from "./models/numeric-input-field-component-state";

/**
 * <p style="color: #9B9B9B; font-style: italic">(no description available)</p>
 */
export class NumericInputFieldComponent extends Component<NumericInputFieldComponentProps, NumericInputFieldComponentState>
{
    ...
    constructor(props: NumericInputFieldComponentProps)
    {
        super(props);
    ...
    componentDidUpdate(prevProps: NumericInputFieldComponentProps): void
    {
