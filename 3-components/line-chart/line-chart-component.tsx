...
import {LineChartCoordinate} from "./models/line-chart-coordinate";
import {LineChartLineSettings} from "./models/line-chart-line-settings";
import {LineChartLineStyle} from "./models/line-chart-line-style";

/**
 * <p style="color: #9B9B9B; font-style: italic">(no description available)</p>
 */
export class LineChartComponent extends Component<LineChartComponentProps>
{
    ...
    private drawLineGraphs(canvasCtx: CanvasRenderingContext2D): void
    {
        ...
        this.getLinesSettings().forEach((lineSettings): void =>
        {
            ...
            {
                case LineChartLineStyle.Dash:
                    canvasCtx.setLineDash([10]);
                    break;
                case LineChartLineStyle.Dot:
    ...
    private getCanvasCoordinate(indexX: number, valueY = 0): LineChartCoordinate
    {
    ...
    private getLinesSettings(): LineChartLineSettings[]
    {
        const linesSettings: LineChartLineSettings[] = [];
        this.props.dataY.forEach((dataY): void =>
        {
            const lineSettings: LineChartLineSettings = {
                coordinates: [],
