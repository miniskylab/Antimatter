...
export const menuItems: DropdownMenuProps["menuItems"] = {
    ...
    "neque": {displayText: "Neque"},
    "elementum": {displayText: "Elementum"},
    "curabitur": {displayText: "Curabitur"},
    "pulvinar": {displayText: "Pulvinar"},
    "imperdiet": {displayText: "Imperdiet"},
    "feugiat": {displayText: "Feugiat"},
    "pharetra": {displayText: "Pharetra"}
};
