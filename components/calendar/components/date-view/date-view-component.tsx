...
import {DateViewHighlightedDate} from "./models/date-view-highlighted-date";

/**
 * <p style="color: #9B9B9B; font-style: italic">(no description available)</p>
 */
export class DateViewComponent extends Component<DateViewComponentProps>
{
    private today: Date;
    ...
    private getHighlightedDate(date: Date): DateViewHighlightedDate
    {
